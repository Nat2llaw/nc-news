...
import { fetchApiSortedArticlesByTopic } from "../../utils/Api";
import { useNavigate } from "react-router-dom";
import TopicArticles from "./TopicArticles";
import "./SortOrderTopics.css";

const SortOrderTopics = ({ topic }) => {
  ...
  useEffect(() => {
      fetchApiSortedArticlesByTopic(topic, sortby, orderby)
      .then((res) => {
        setArticles(res);
        setLoading(false);
        navigate(`/articles/topic/${topic}/sortby/${sortby}/order/${orderby}`);
      })
      .catch((error) => {
...
export default SortOrderTopics;